      ...
      <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.contentContainer}>
          <View style={styles.card}>
            ...
            <ThemedText themeColor="textSecondary">With your permission, we use Google Analytics to understand aggregate site usage and improve {PUBLIC_BRAND_NAME}. Google may process browser, device, approximate location, page category, and approved interaction data under its own privacy terms. Scouty does not send Google your name, email, account ID, raw recommendation request, contact message, Letterboxd username, exact title history, or token-bearing URL.</ThemedText>
            <ThemedText themeColor="textSecondary">Optional Google Analytics is denied until you choose “Accept analytics.” You can decline without losing functionality and can later accept or withdraw using “Analytics preferences” in the footer. Withdrawal stops future collection and Scouty attempts to remove first-party Google Analytics cookies; browser or domain restrictions may prevent deleting every existing cookie automatically.</ThemedText>
            ...
            <ThemedText themeColor="textSecondary">Raw operational events are retained for up to 90 days. Daily non-identifying aggregates may be retained longer for product reporting. Service providers involved in Scouty include hosting, database, email, movie metadata, recommendation, Letterboxd RSS, and, after consent, Google Analytics providers.</ThemedText>
